...
```
    ...
    ## IGRAPH 3aa2ae8 DNW- 4 4 -- 
    ## + attr: name (v/c), group (v/c), score (v/n), interaction (e/c),
    ## | weight (e/n)
    ## + edges from 3aa2ae8 (vertex names):
...
```
    ...
    ## IGRAPH 94447ec UNW- 845 1544 -- 
    ## + attr: name (v/c), weight (e/n)
    ## + edges from 94447ec (vertex names):
...
![](class17_files/figure-gfm/unnamed-chunk-10-2.png)<!-- -->
